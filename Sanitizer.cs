...
namespace ConsoleApplication1
{
    ...
    {
        public static Regex forbiddenTags = new Regex("^(plaintext|marquee|meta|blink|svg|feImage|script|object|embed|link|style|form|input|textarea|video|area|audio|canvas|frame|frameset|html|s|a|img|table|thead|tbody|tfoot|tr|th|td|dd|dl|dt|em|h1|h2|h3|h4|h5|h6|li|ul|ol|span|div|strike|strong|" +
                "sub|sup|pre|del|code|blockquote|strike|kbd|br|hr|map|param|link|form|small|big|a|abbr|acronym|address|applet|area|article|aside|b|base|basefont|bdi|bdo|big|blockquote|body|br|button|caption|center|cite|code|col|colgroup|datalist|dd|del|details|dfn|dialog|dir|div|dl|dt|em|fieldset|figcaption|figure|font|footer|h1|h2|h3|h4|head|header|hr|i|iframe|img|ins|kbd|keygen|label|legend|li|main|map|mark|menu|menuitem|meta|meter|nav|noframes|noscript|ol|optgroup|option|output|p|param|picture|pre|progress|q|rp|rt|ruby|s|samp|section|select|small|source|span|strike|strong|sub|summary|sup|table|tbody|td|tfoot|th|thead|time|title|tr|track|tt|u|ul|var|wbr)$");
        public static Regex allowedTags = new Regex("^(b|p|i)$");
         ...
         */
        public static SanitizeResult sanitizer(String html, bool isConsiderAllowedTag = false)
        {
            return sanitizer(html, allowedTags, forbiddenTags, isConsiderAllowedTag);
        }
